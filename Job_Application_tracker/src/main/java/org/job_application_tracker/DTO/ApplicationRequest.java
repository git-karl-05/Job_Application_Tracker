...
public class ApplicationRequest {
    ...
    public ApplicationRequest(Long id, String company, LocalDate applicationDate, LocalTime time, String location, LocalDate postedDate, String url, String documentUrl) {
        this.id = id;
